...
Implementing a session token mechanism, where the hub assigns a token at matchmaking time and the room could accept reconnections bearing that token within a grace period, would improve the player experience on unstable networks.
