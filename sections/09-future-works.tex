...
Extending it with a lightweight persistent backend (e.g., SQLite per room, or a shared Redis instance) would enable game replay, player statistics, and leaderboards across sessions.
...
The generator could be seeded deterministically to ensure all clients render the same map.
