...
I also wrote the \textbf{unit test suite} for the Hub Server, designed to target business logic exclusively and to surface real bugs rather than verify trivial implementation details.
