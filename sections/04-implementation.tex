...
No authentication or authorization is implemented. This is documented as a known limitation in \cref{security}.
...
\begin{itemize}
  ...
  \item \textbf{Listener thread}: runs the UDP receive loop in \texttt{HubSocketHandler}.
...
The Room Server is packaged in a Docker container. \cref{deployment-room}


The overview of the implementation is shown in figure \cref{fig:implementation-system-overview}
\begin{figure}
    \centering
    \includegraphics[width=0.85\textwidth]{figures/implementation-system-overview.png}
    \caption{Matchmaking process}
    \label{fig:implementation-system-overview}
\end{figure}