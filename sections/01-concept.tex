...
This design ensures that clients always receive a response, even if some hubs in the cluster are temporarily unreachable — the defining property of an AP system.
